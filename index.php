          ...
          <div class="swiper-container hotel-slider hotel__slider">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="slide swiper-slide hotel-slider__item">
                <img class="slide__image" src="img/slide.jpg" alt="">
              </div>
              <div class="slide swiper-slide hotel-slider__item">
                <img class="slide__image" src="img/slide2.jpg" alt="">
              </div>
              <div class="slide swiper-slide hotel-slider__item">
                <img class="slide__image" src="img/slide3.jpg" alt="">
              </div>
              <div class="slide swiper-slide hotel-slider__item">
                <img class="slide__image" src="img/slide4.jpg" alt="">
              </div>
              <div class="slide swiper-slide hotel-slider__item">
                <img class="slide__image" src="img/slide5.jpg" alt="">
              </div>
              <div class="slide swiper-slide hotel-slider__item">
                <img class="slide__image" src="img/slide6.jpg" alt="">
              </div>
            </div><!-- /.swiper-wrapper -->
    ...
    <div class="packages-grid">
      ...
      <div class="packages__card packages__card-first">
        ...
        <div class="packages__images-first">
          <img src="img/packages-hotel-1.jpg" alt="foto: Hotel Blue Haven" class="packages__image packages__image--first">
        ...
        <div class="packages__info packages__info-first">
          ...
          <div class="packages__info-wrapp">
            ...
            <h2 class="packages__offer-title">Hotel Blue Haven</h2>
          </div>
          ...
          <div class="packages-price">
            ...
            <button class="packages__price-button">Book Now</button>
            
            
            <div class="offer packages__offer packages__offer-first">Flash Offer</div>
      ...
      <div class="packages__cards packages__cards-successive">
        ...
        <div class="packages__images-successive">
          <img src="img/packages-hotel-2.jpg" alt="foto: Hotel Blue Haven" class="packages__image">
        </div><!-- /.packages__image-successive -->

        <div class="packages__inform">

          <h2 class="packages__offer-title">LUX* Belle Mare</h2>
          ...
          <div class="packages-price">
            ...
            <div class="offer packages__offer packages__offer-successive">Flash Offer</div>
      ...
      <div class="packages__cards packages__cards-successive">
        ...
        <div class="packages__images-successive">
          <img src="img/packages-hotel-3.jpg" alt="foto: Hotel Blue Haven" class="packages__image">
        </div><!-- /.packages__image-successive -->

        <div class="packages__inform">

          <h2 class="packages__offer-title">White Palace</h2>
      ...
      <div class="packages__cards packages__cards-successive">
        ...
        <div class="packages__images-successive">
          <img src="img/packages-hotel-4.jpg" alt="foto: Hotel Blue Haven" class="packages__image">
        </div><!-- /.packages__image-successive -->

        <div class="packages__inform">

          <h2 class="packages__offer-title">Luxury Place</h2>
      ...
      <div class="packages__cards packages__cards-successive packages__card-last">
        ...
        <div class="packages__images-successive">
          <img src="img/packages-hotel-5.jpg" alt="foto: Hotel Blue Haven" class="packages__image">
        </div><!-- /.packages__image-successive -->

        <div class="packages__inform">

          <h2 class="packages__offer-title">Hotel Five Star</h2>
  ...
  <section class="newsletter parallax-window" data-parallax="scroll" data-image-src="img/newsletter-bg.jpg">
    <div class="container newsletter-wrapper">
      ...
      <form action="send.php" method="POST" class="subscripe newsletter__subscripen">
        <input type="text" class="subscripe__input" placeholder="Your email address" name="email">
